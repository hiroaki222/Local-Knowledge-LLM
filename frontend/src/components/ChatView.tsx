...
export default function ChatView({ thread }: { thread: Thread }) {
  ...
  return (
    <>
      <div className="min-h-[64.25rem] flex-1 overflow-hidden px-4 py-6 sm:px-6">
              ...
              v.role == 'user' ? (
                <div className="flex items-start justify-end gap-4" key={`user-${i}`}>
                  <div className="grid gap-1">
                    <div className=" max-w-[500px] whitespace-pre-wrap rounded-lg bg-primary p-3 text-primary-foreground">
                      {v.content}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4" key={`ai-${i}`}>
                  ...
                  <div className="grid gap-1">
                    <div className=" max-w-[500px] whitespace-pre-wrap rounded-lg bg-muted p-3">{v.content}</div>
                  </div>
                </div>
              ),
            )}
